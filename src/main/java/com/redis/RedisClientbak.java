...
public class RedisClientbak {
    ...
    { 
        ...
        jedisPool = new JedisPool(config,"115.29.13.27",6379);
    }
    ...
    { 
        ...
        shards.add(new JedisShardInfo("115.29.13.27", 6379, "master")); 
    ...
    { 
       ...
       // System.out.println("清空库中所有数据："+jedis.flushDB());
        ...
        Set<String> keys = jedis.keys("SZ000063:details"); 
    ...
    {  
    	...
    	System.out.println("SZ600696:volumes=="+jedis.get("SZ600696:volumes"));
    	System.out.println("SZ600696:latest=="+jedis.get("SZ600696:latest"));
    	System.out.println("SZ600696:volumes=="+jedis.get("SZ600696:volumes"));
    	System.out.println("SZ600696:volumes=="+jedis.get("SZ600696:volumes"));
    	System.out.println("type===="+jedis.type("SZ600696:details"));
    	System.out.println("len========="+jedis.llen("SZ600696:details"));
    	System.out.println("SZ600696:details========="+jedis.lrange("SZ600696:details", 0, -1));
    	
    	String value= jedis.get("SZ600696:volumes");
    	System.out.println("SZ600696:volumes=="+value);
    	//List<String> list = jedis.lrange("SZ000063:details", 0, 1);
    ...
    public static void main(String[] args) throws ClientProtocolException, IOException {
       ...
       new RedisClientbak().show(); 
    	//RedisClient rc = new RedisClient(); 
    	//System.out.println(rc.getValue("SH510710:volumes"));
		...
		//date1 = cal.getTime();
    	//String str = DateUtils.DateToStr(da, "yyyy-MM-dd HH:mm:ss");
    	//da = DateUtils.StrToDate("2015-08-05 17:32:24", "yyyy-MM-dd HH:mm:ss");
    	/*Date date1 = new Date(1438831800L*1000);
    	//date1.setTime(1438738320L*1000);
    	System.out.println("========"+ DateUtils.DateToStr(date1, "yyyy-MM-dd HH:mm:ss")+"============"+date1.getTime()/1000);
    	
    	String time1 = "2015-08-09 9:30";
    	String time2 = "2015-08-06 11:30";
    	Date d1 = DateUtils.StrToDate(time1, "yyyy-MM-dd HH:mm:ss");
    	Date d2 = DateUtils.StrToDate(time2, "yyyy-MM-dd HH:mm:ss");
    	System.out.println("============="+((d2.getTime()-d1.getTime())/1000/60));
    	
    	List<String> mist = Common.time_sharing_minutes_in_date(d1);
    	System.out.println("==========="+JSONArray.fromObject(mist));
    	
    	String url = "http://suggest3.sinajs.cn/suggest/type=11,12,13,14,15&key=62";
    	String url2 ="http://hq.sinajs.cn/list=s_sh000001,s_sz399001,s_sz399006";
		String stock = HttpRequestUtil.request(url2, null, HttpRequestUtil.REQUEST_TYPE_GET, "GBK");
		String stock2 = Common.getStock(url2);
		stock = stock.substring(stock.indexOf("=")+1).replace("\"", "");
